...
* [Web3.js](https://github.com/ethereum/web3.js/) - Javascript Web3
    ...
    * [flex-contract](https://github.com/merklejerk/flex-contract) and [flex-ether](https://github.com/merklejerk/flex-ether) Modern libraries for easily interacting with smart contracts and making ether transactions, with no need for an existing web3 provider or wallet.
    * [ez-ens](https://github.com/merklejerk/ez-ens) Simple, zero-configuration Ethereum Name Service resolver.
